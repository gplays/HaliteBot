...
while True:
    ...
    for ship in game_map.get_me().all_ships():
        ...
        for planet in game_map.all_planets():
            ...
            # If we can dock, let's (try to) dock. If two ships try to dock
            # at once, neither will be able to.
            if ship.can_dock(planet):
                ...
                navigate_command = ship.navigate(
                        ...
                        ignore_ships=True)
                # If the move is possible, add it to the command_queue (if
                # there are too many obstacles on the way
